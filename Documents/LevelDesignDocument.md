...
| Giorgio Liggio | 06/01/2018 | Updated level goals (final version).     |  0.5.2  |
...
**Game title:** *Space Beyond Space - A Doctor Who Story* (temporary)
...
**Developed level sub-sections:** Y

**Level name:** *Disclosure* (temporary)
...
#### 2.3.1.1. Clara Oswald @

[ Name / Role / Archetype / Affiliation / Bio (values, personality, look&feel) / Features ]
...
There are the enemies the player must face during the game.
...
![World diagram](img/GSD_WorldDiagram.png?raw=true)
...
# 3. Level description: *Disclosure* (temporary) @

Introduction paragraph.

## 3.1. Level information

Level sum-up information paragraph: name, type, setting, goal(s), involved characters, involved enemies, involved skills, involved plot moments, preconditions.

## 3.2. Level diagram

Level diagram schema (not detailed).

## 3.3. Section description: *Unnamed Section* 
...
Level section diagram schema (detailed).
